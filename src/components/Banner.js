...
const Banner = () => {
    ...
    const prevSlide=()=>
    {
        // Make the next value the current slide. Iterate throught the data array. 
    ...
    <div className='w-full h-auto'>
        <div className='w-screen-h=[650px] relative'>
            ...
            <div className='absolute w-fit left-0 right-0 mx-auto flex gap-8 bottom-44'>
                ...
                hover:cursor-pointer hover:bg-gray-700 hover:text-white active:bg-gray-900 duration-300'><HiArrowLeft/></div>
                <div onClick = {nextSlide} className='w-14 h-12 border-[1px] border-gray-700 flex items-center justify-center 
                hover:cursor-pointer hover:bg-gray-700 hover:text-white active:bg-gray-900 duration-300'><HiArrowRight/></div>
            </div>
        </div>
    </div>
  )
